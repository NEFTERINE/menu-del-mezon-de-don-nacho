...
$fkDireccion = $funcionesDireccion->insertarDireccion($cliente['colonia'], $cliente['calle'], $cliente['referencias']);
$fkCliente = $funcionesCliente->insertarCliente($fkPersona, $fkDireccion);
...
try {
    ...
    foreach ($carrito as $item) {
        ...
        $stmt_detalle->execute([
            ...
            ':fk_tipo_servicio' => 1 // por ejemplo: 1 = para llevar, 2 = domicilio, etc.
        ]);
