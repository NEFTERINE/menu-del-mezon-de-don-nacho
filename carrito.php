...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['abrir_modal'])) {
    // Guardar datos en sesión para usarlos en los siguientes modales
    if (isset($_POST['nombre'])) $_SESSION['datos_cliente'] = $_POST;

    $modal_id = $_POST['abrir_modal'];
    // NO redirigir, dejar que el JavaScript abra el modal
}

// Mostrar mensajes de éxito/error
if (isset($_GET['pedido']) && $_GET['pedido'] === 'exito') {
    echo '<div class="alert alert-success">¡Pedido confirmado con éxito!</div>';
}
...
<body>
    ...
    <a href="index.php" id="regreso" class="button">Atrás</a>
        ...
        ?>
                <div class="productos">
                    ...
                    <div class="cantidad-control">
                        <a class="button"
                            href="funciones/eliminar_producto.php?id=<?= $item['id'] ?>"
                            onclick="return confirm('¿Seguro que quieres eliminar?')"><i id="eliminar_p" class="bi bi-trash"></i></a>
