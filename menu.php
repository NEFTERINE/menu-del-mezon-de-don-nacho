...
<body>
  ...
  <div class="navbar">
    ...
    <div class="baner">
      <img style="overflow: hidden;" id="baner" src="imagenes/bannerDonNacho.jpg"
        alt="Baner">
    </div>
    <div class="logo-container">
      ...
      <a
        ...
        <i class="fa-solid fa-map-location-dot" id="mapa" style="cursor: pointer;"> </i> </a>
...
<div class="barra">
  ...
  <?php
  // Verificar si el usuario está logueado y es admin (rol = 1)
